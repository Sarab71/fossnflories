...
const ProductPage = () => {
  ...
  const generateWhatsAppLink = () => {
    const phoneNumber = "919319747717"; // Your WhatsApp number
    ...
    return `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`; // WhatsApp URL with your number and message
  };
